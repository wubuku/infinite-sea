module infinite_sea_common::ts_random_util {
    ...
    public fun split_int_with_epoch_timestamp_ms(cxt: &TxContext, seed: vector<u8>, value: u64, n: u64): vector<u64> {
        ...
        while (i < n) {
            ...
            let r = next_int_with_epoch_timestamp_ms(cxt, seed, bound);
    ...
    public fun next_int_with_epoch_timestamp_ms(cxt: &TxContext, seed: vector<u8>, bound: u64): u64 {
        (next_u256_with_epoch_timestamp_ms(cxt, seed) % (bound as u256) as u64)
    }

    /// Get pseudo-random u256 with epoch timestamp in milliseconds and another value as seed.
    public fun next_u256_with_epoch_timestamp_ms(cxt: &TxContext, seed: vector<u8>): u256 {
