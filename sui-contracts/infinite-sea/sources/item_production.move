...
module infinite_sea::item_production {
    ...
    friend infinite_sea::item_production_create_logic;
    friend infinite_sea::item_production_update_logic;
    ...
    public fun production_materials(item_production: &ItemProduction): ProductionMaterials {
        item_production.production_materials
    }

    public(friend) fun set_production_materials(item_production: &mut ItemProduction, production_materials: ProductionMaterials) {
    ...
    public fun item_production_created_production_materials(item_production_created: &ItemProductionCreated): ProductionMaterials {
    ...
    public fun item_production_updated_production_materials(item_production_updated: &ItemProductionUpdated): ProductionMaterials {
