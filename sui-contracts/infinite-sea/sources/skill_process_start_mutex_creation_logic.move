...
// module infinite_sea::skill_process_start_mutex_creation_logic {
...
//         ctx: &TxContext,
//     ): skill_process::MutexCreationProcessStarted {
...
//         skill_process::new_mutex_creation_process_started(
//             skill_process,
//             item_id,
//             energy_cost,
//             resource_cost,
...
//     ) {
//         let item_id = skill_process::mutex_creation_process_started_item_id(mutex_creation_process_started);
//         //let energy_cost = skill_process::mutex_creation_process_started_energy_cost(mutex_creation_process_started);
//         let resource_cost = skill_process::mutex_creation_process_started_resource_cost(mutex_creation_process_started);
//         let started_at = skill_process::mutex_creation_process_started_started_at(mutex_creation_process_started);
//         let creation_time = skill_process::mutex_creation_process_started_creation_time(mutex_creation_process_started);
