...
import org.dddml.suiinfinitesea.specialization.NullReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.dddml.suiinfinitesea.*"); //add annotation mappings
