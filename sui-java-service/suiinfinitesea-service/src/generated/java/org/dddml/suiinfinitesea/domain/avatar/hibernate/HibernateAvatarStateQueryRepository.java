...
public class HibernateAvatarStateQueryRepository implements AvatarStateQueryRepository {
    ...
    public AvatarState get(String id) {
        ...
        AvatarState state = (AvatarState)getCurrentSession().get(AbstractAvatarState.SimpleAvatarState.class, id);
    ...
    public Iterable<AvatarState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(AvatarState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<AvatarState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(AvatarState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public AvatarState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<AvatarState> list = (List<AvatarState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public AvatarState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
