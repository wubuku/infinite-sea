...
public class HibernateAvatarChangeStateQueryRepository implements AvatarChangeStateQueryRepository {
    ...
    public AvatarChangeState get(String id) {
        ...
        AvatarChangeState state = (AvatarChangeState)getCurrentSession().get(AbstractAvatarChangeState.SimpleAvatarChangeState.class, id);
    ...
    public Iterable<AvatarChangeState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(AvatarChangeState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<AvatarChangeState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(AvatarChangeState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public AvatarChangeState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<AvatarChangeState> list = (List<AvatarChangeState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public AvatarChangeState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
