...
public abstract class AbstractSkillProcessState implements SkillProcessState.SqlSkillProcessState {
    ...
    public void mutate(Event e) {
        ...
        } else if (e instanceof AbstractSkillProcessEvent.MutexCreationProcessCompleted) {
            when((AbstractSkillProcessEvent.MutexCreationProcessCompleted)e);
        } else {
...
//}
    ...
    public void when(AbstractSkillProcessEvent.MutexCreationProcessCompleted e) {
        throwOnWrongEvent(e);
