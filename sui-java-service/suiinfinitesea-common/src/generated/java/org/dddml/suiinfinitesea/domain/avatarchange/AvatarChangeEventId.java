...
public class AvatarChangeEventId implements Serializable {
    ...
    public AvatarChangeEventId()
    {
    }

    public AvatarChangeEventId(String avatarId, BigInteger version)
    {
        this.avatarId = avatarId;
        this.version = version;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        AvatarChangeEventId other = (AvatarChangeEventId)obj;
        return true 
            && (avatarId == other.avatarId || (avatarId != null && avatarId.equals(other.avatarId)))
    ...
    public int hashCode()
    {
        ...
        if (this.avatarId != null) {
            hash += 13 * this.avatarId.hashCode();
        }
