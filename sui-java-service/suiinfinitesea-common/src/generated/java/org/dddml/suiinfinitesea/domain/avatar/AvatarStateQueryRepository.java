...
public interface AvatarStateQueryRepository {
    ...
    AvatarState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders);

    AvatarState getFirst(Map.Entry<String, Object> keyValue, List<String> orders);
